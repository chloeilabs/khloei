...
export const KHLOEI_COMPUTER_TOOLS: FunctionTool[] = [
  ...
  },
  {
    ...
    description:
      'Ask the person to enter one password, one-time code, card number, or other secret directly into a field without exposing it to the model. Snapshot and click the field first. The value is typed but not submitted.',
    parameters: {
      type: 'object',
      properties: {
        label: {
...
function agentToolCall(
  ...
  return {
    ...
    call_id: details?.toolCall?.callId ?? `agents-${crypto.randomUUID()}`,
    name,
    type: 'function_call',
  }
}

async function runAgentComputerTool(
  name: string,
  input: unknown,
  ...
  const outcome = await executeComputerTool(
    agentToolCall(name, input, details),
    context.context.gateway,
  )
  if (outcome.ok && isBrowserComputerTool(name)) {
    await context.context.onBrowserAction()
  }
  // The Responses API expects function output as text. Returning the object directly would become
  // "[object Object]" in an OpenAI-compatible provider and hide the action result from the agent.
  return JSON.stringify(outcome)
}

/** Typed local tools consumed by the OpenAI Agents SDK runner. */
  ...
  return [
    tool({
      ...
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_navigate', input, context, details),
    }),
    tool({
      name: 'computer_read',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_read', input, context, details),
    }),
    tool({
      name: 'computer_snapshot',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_snapshot', input, context, details),
    }),
    tool({
      name: 'computer_request_help',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_request_help', input, context, details),
    }),
    tool({
      name: 'computer_request_secret',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_request_secret', input, context, details),
    }),
    tool({
      name: 'computer_list_tabs',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_list_tabs', input, context, details),
    }),
    tool({
      name: 'computer_open_tab',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_open_tab', input, context, details),
    }),
    tool({
      name: 'computer_switch_tab',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_switch_tab', input, context, details),
    }),
    tool({
      name: 'computer_close_tab',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_close_tab', input, context, details),
    }),
    tool({
      name: 'computer_click',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_click', input, context, details),
    }),
    tool({
      name: 'computer_type',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_type', input, context, details),
    }),
    tool({
      name: 'computer_key',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_key', input, context, details),
    }),
    tool({
      name: 'computer_scroll',
      description: 'Scroll the current browser page vertically.',
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_scroll', input, context, details),
    }),
    tool({
      name: 'computer_list_files',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_list_files', input, context, details),
    }),
    tool({
      name: 'computer_read_file',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_read_file', input, context, details),
    }),
    tool({
      name: 'computer_write_file',
      description:
      ...
      strict: true,
      execute: (input, context?: RunContext<ComputerAgentContext>, details?) =>
        runAgentComputerTool('computer_write_file', input, context, details),
    }),
  ]
}
